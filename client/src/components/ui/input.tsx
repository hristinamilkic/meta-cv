    ...
    return (
      <div className="relative">
        <input
          type={inputType}
          className={cn(
            "flex h-11 w-full rounded-lg border border-[hsl(var(--mc-accent))] bg-transparent px-3 py-1 text-base shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-white/60 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-md autofill:bg-[hsl(var(--mc-background))] autofill:shadow-[inset_0_0_0px_1000px_hsl(var(--mc-background))]",
            variant === "dark"
