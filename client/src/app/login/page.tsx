      ...
      <div className="flex flex-col md:flex-row w-full max-w-2xl md:max-w-5xl rounded-3xl overflow-hidden shadow-2xl bg-transparent">
        ...
        <div className="flex-1 flex flex-col justify-center px-4 sm:px-8 md:px-10 py-8 sm:py-12 md:py-16">
          ...
          <form className="flex flex-col gap-4 sm:gap-6">
            ...
            <button type="submit" className="bg-[hsl(var(--mc-accent))] text-white text-base sm:text-lg font-semibold rounded-xl py-2 sm:py-3 mt-2 shadow-lg hover:bg-[hsl(var(--mc-warm))] transition">LOGIN</button>
          </form>
          <div className="mt-6 text-xs sm:text-sm text-white/80">
            Forgotten password? <Link href="/reset-password" className="underline text-[hsl(var(--mc-accent))]">Sign up</Link>
          </div>
        </div>
        {/* Right: Image */}
